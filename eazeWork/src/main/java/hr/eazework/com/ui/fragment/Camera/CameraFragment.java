...
import static hr.eazework.com.ui.util.AppsConstant.BACK_CAMREA_OPEN;
import static hr.eazework.com.ui.util.AppsConstant.FRONT_CAMREA_OPEN;
 ...
 //   private boolean canTakePhoto = false;
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == REQUEST_IMAGE_CAPTURE && resultCode == RESULT_OK) {
            ...
            onPictureTaken(ImageUtil.bitmapToByteArray(rotateImage(imageBitmap,270)),camera);
        }
    }
